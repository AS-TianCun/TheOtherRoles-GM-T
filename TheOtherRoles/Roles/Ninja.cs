    ...
    public class Ninja : RoleBase<Ninja> {
        ...
        public override void OnMeetingEnd()
        {
            if (player == PlayerControl.LocalPlayer)
            {
                if (penalized)
                {
                    player.SetKillTimerUnchecked(GameOptionsManager.Instance.currentGameOptions.GetFloat(FloatOptionNames.KillCooldown) + killPenalty);
                }
                else
                {
        ...
        public override void OnKill(PlayerControl target)
        {
            ...
            if (PlayerControl.LocalPlayer == player)
                player.SetKillTimerUnchecked(GameOptionsManager.Instance.currentGameOptions.GetFloat(FloatOptionNames.KillCooldown) + penalty);
        }
